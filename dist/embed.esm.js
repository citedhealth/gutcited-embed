/* gutcited-embed v1.0.0 | MIT | https://widget.gutcited.com */
...
function makeWidgetElement(widgetType, initFn, domainAttrs) {
  ...
  return class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this._syncDataAttrs();
      initFn(this, '{"site":"gutcited","name":"GutCited","domain":"gutcited.com","accent":"#059669","attribute":"data-gutcited","apiBase":"https://gutcited.com/api/","searchPath":"/search/","organName":"Gut Health","organSlug":"gut"}');
    }
     ...
     */
    _syncDataAttrs() {
      const attrKey = '{"site":"gutcited","name":"GutCited","domain":"gutcited.com","accent":"#059669","attribute":"data-gutcited","apiBase":"https://gutcited.com/api/","searchPath":"/search/","organName":"Gut Health","organSlug":"gut"}'.attribute.replace("data-", "");
...
(function bootstrap() {
  const config = '{"site":"gutcited","name":"GutCited","domain":"gutcited.com","accent":"#059669","attribute":"data-gutcited","apiBase":"https://gutcited.com/api/","searchPath":"/search/","organName":"Gut Health","organSlug":"gut"}';
